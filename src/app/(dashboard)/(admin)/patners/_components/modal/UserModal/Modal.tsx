                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-white">
                                <DialogTitle className="text-2xl font-bold">
                                    {status === 'CREATE' && 'Nouvel établissement'}
                                    {status === 'DETAIL' && 'Profil établissement'}
                                    {status === 'EDIT' && 'Modifier l\'établissement'}
                                </DialogTitle>
                                <DialogDescription className="text-white/90 text-sm mt-1">
                                    {status === 'CREATE' && 'Ajoutez un nouvel établissement au système'}
